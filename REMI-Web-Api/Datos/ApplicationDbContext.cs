...
using REMI_Web_Api.Models;

namespace REMI_Web_Api.Datos;
...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<detallesPedido>(entity =>
        {
            ...
            entity.HasOne(d => d.codigoPedidoNavigation).WithMany(p => p.detalles)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_detalles_pedidos");

            entity.HasOne(d => d.codigoProductoNavigation).WithMany(p => p.detalles)
                .OnDelete(DeleteBehavior.ClientSetNull)
